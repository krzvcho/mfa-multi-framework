...
const App = (container) => {
  ...
  const scoreMinus = container.querySelector("#score-minus");
  const scoreReset = container.querySelector("#score-reset");
  const scorePlus = container.querySelector("#score-plus");

  const timerDisplay = container.querySelector("#timer-display");
  const timerStart = container.querySelector("#timer-start");
  const timerStop = container.querySelector("#timer-stop");
...
export default (props) => {
  return {
    default: class VanillaApp {
      constructor() {
        this.cleanup = null;
      }

      mounted() {
        this.cleanup = App(this.$el);
      }
